            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    <div class="tab-content">
                        <form enctype="multipart/form-data" action="{{route('admin.category.update', $category->id)}}" method="POST" class="form-horizontal validate">
                            @csrf
                            <div class="form-group">
                                <label for="field-1" class="col-sm-3 control-label">Kategori Adı </label>
                                <div class="col-sm-5">
                                    <input type="text" class="slug-name form-control" name="name" value="{{ $category->name }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="slug-url form-control" name="slug" value="{{ $category->slug }}" required>
