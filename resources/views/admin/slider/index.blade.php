...
@section('content')
                ...
                <form action="" id="deleteForm" method="GET">
                    <div class="modal-content">
                        <div class="modal-header bg-danger">
                            ...
                            <h4 class="modal-title text-center">SLAYT SİLME İŞLEMİ</h4>
                        </div>
                        <div class="modal-body">
                            <p class="text-center">Bu slaytı silmek istediğinize emin misiniz?</p>
                        </div>
        ...
        $(document).ready(function(){
            $("#datatable").DataTable({
                ...
                columns: [
                    ...
                    {data:'title', name:'title', ordarable: true, searchable: false},
    ...
    <script type="text/javascript">
        ...
        {
            var ida = id;
            var url = '{{ route("admin.slider.destroy", ":ida") }}';
