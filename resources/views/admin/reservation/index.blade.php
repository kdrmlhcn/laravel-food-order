...
@section('content')
                ...
                <form action="" id="deleteForm" method="GET">
                    <div class="modal-content">
                        <div class="modal-header bg-danger">
                            ...
                            <h4 class="modal-title text-center">REZERVASYON SİLME İŞLEMİ</h4>
                        </div>
                        <div class="modal-body">
                            <p class="text-center">Bu rezervasyonu silmek istediğinize emin misiniz?</p>
                        </div>
        ...
        $(document).ready(function(){
            $("#datatable").DataTable({
                ...
                columns: [
                    ...
                    {data:'type', name:'type', ordarable: true, searchable: false},
                    {data:'date', name:'date', ordarable: true, searchable: false},
    ...
    <script type="text/javascript">
        ...
        {
            var ida = id;
            var url = '{{ route("admin.reservation.destroy", ":ida") }}';
